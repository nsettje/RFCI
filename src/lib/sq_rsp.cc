//Transposes the eigenvectors after calculating the solution to eigenproblem

#include "lib/mkl_wrapper.h"
#include "lib/memory.h"
//DIAGONALIZE array and store the eigenvectors as columns of e_vecs
//PILFERED FROM PSI4 SOURCE CODE
